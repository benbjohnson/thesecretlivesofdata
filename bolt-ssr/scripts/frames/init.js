...
define(["./title", "./overview"], //, "./bolt_routing", "./initial_resolution", "./read_replicas", "./conclusion"],
    function (title, overview){ //, bolt_routing, initial_resolution, read_replicas, conclusion) {
